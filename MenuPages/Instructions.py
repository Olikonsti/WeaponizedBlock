...
class Instructions(Frame):
    def __init__(self, notebook, menu):
        ...
        Label(self.frame.interior, text=f"How to Play", font="System 17", fg="yellow", justify=LEFT).pack(pady=(5, 0), padx=5,anchor="w")
        ...
        Label(self.frame.interior, text=f"How to Win", font="System 17", fg="yellow", justify=LEFT).pack(pady=(5, 0), padx=5,
                                                                                            anchor="w")
        ...
        Label(self.frame.interior, text=f"How to Loose", font="System 17", fg="yellow", justify=LEFT).pack(pady=(5, 0),
                                                                                                         padx=5,
                                                                                                         anchor="w")
        Label(self.frame.interior, text=f"You loose the game if you get eaten or shot by a AI_Snake", font="System 17",
              justify=LEFT).pack(pady=(5), padx=50,
                                 anchor="w")
